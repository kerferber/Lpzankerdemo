      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex md:items-center md:space-x-8">
            <a href="#features" className="text-text-main hover:text-primary transition-colors font-medium">Funcionalidades</a>
            <a href="#how-it-works" className="text-text-main hover:text-primary transition-colors font-medium">Como funciona</a>
            <a href="#target-audience" className="text-text-main hover:text-primary transition-colors font-medium">Para quem é</a>
            <a href="#pricing" className="text-text-main hover:text-primary transition-colors font-medium">Planos</a>
            <a href="#faq" className="text-text-main hover:text-primary transition-colors font-medium">FAQ</a>
          </nav>
