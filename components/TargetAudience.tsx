    ...
    <section ref={sectionRef} id="target-audience" className="py-16 md:py-24 bg-light-blue overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className={`${inView ? cardAnimations[0] : 'opacity-0'}`} style={{animationDelay: '200ms'}}>
            <AudienceCard 
          ...
          <div className={`${inView ? cardAnimations[1] : 'opacity-0'}`} style={{animationDelay: '300ms'}}>
            <AudienceCard 
          ...
          <div className={`${inView ? cardAnimations[2] : 'opacity-0'}`} style={{animationDelay: '400ms'}}>
            <AudienceCard 
