    ...
    <footer ref={sectionRef} className="bg-slate-900 text-slate-400 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className={`lg:col-span-2 transition-all duration-700 ease-out ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`} style={{transitionDelay: '300ms'}}>
            <h4 className="font-semibold text-white tracking-wider uppercase">Soluções</h4>
            <ul className="mt-4 space-y-3">
              <li><a href="#features" className="hover:text-white transition-colors">Orçamento</a></li>
              <li><a href="#features" className="hover:text-white transition-colors">Cronograma</a></li>
              <li><a href="#features" className="hover:text-white transition-colors">Acompanhamento</a></li>
            </ul>
          </div>
          <div className={`lg:col-span-2 transition-all duration-700 ease-out ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`} style={{transitionDelay: '400ms'}}>
          ...
          <div className={`lg:col-span-2 transition-all duration-700 ease-out ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`} style={{transitionDelay: '500ms'}}>
